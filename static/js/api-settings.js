...
const API_PROTOCOLS = ['openai', 'apimart', 'gemini', 'volcengine', 'runninghub', 'jimeng', 'codex', 'gemini-cli', 'dashscope'];
...
async function probeAsync(){
    ...
    try {
        ...
        const keepManualProtocol = ['gemini', 'volcengine', 'jimeng', 'codex', 'gemini-cli', 'dashscope'].includes(currentProtocol);
        ...
        const keepManualProtocol = ['gemini', 'volcengine', 'jimeng', 'codex', 'gemini-cli', 'dashscope'].includes(String(protocolInput?.value || item.protocol || '').toLowerCase());
